...
const { Dictionary, List } = require(`@nkm/collections`);
const { EVENT, POOL } = require(`@nkm/common`);
const { DATA_EVENT, ID } = require(`@nkm/data-core`);
...
class EntryManager extends EcosystemPart {
    ...
    Deploy(p_model) {
        ...
        newLibrary.Subscribe(DATA_EVENT.ITEM_REGISTERED, this._OnEntryRegistered, this);
        newLibrary.Subscribe(DATA_EVENT.ITEM_UNREGISTERED, this._OnEntryUnregistered, this);
    ...
    Conceal(p_model) {
        ...
        newLibrary.Unsubscribe(DATA_EVENT.ITEM_REGISTERED, this._OnEntryRegistered, this);
        newLibrary.Unsubscribe(DATA_EVENT.ITEM_UNREGISTERED, this._OnEntryUnregistered, this);
    ...
    _OnEntryRegistered(p_library, p_entry) {
        ...
        p_entry.metadata.Subscribe(DATA_EVENT.META_UPDATED, this._OnEntryMetaUpdated, this);
    ...
    _CreateCatalogEntry(p_entry, p_options = null) {
        ...
        if (cItem) {
            ...
            cItem.Unsubscribe(EVENT.RELEASED, this._OnCatalogEntryRelease, this);
            cItem.Release();
        }
        ...
        cItem.Subscribe(EVENT.RELEASED, this._OnCatalogEntryRelease, this);
