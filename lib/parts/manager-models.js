...
class ModelManager extends EcosystemPart {
    ...
    _Init() {
        ...
        this._factory.Subscribe(DATA_EVENT.ITEM_REGISTERED, this._OnModelRegistered, this);
        this._factory.Subscribe(DATA_EVENT.ITEM_UNREGISTERED, this._OnModelUnregistered, this);
    ...
    _OnModelRegistered(p_factory, p_model) {
        ...
        var itemOptions = {
            ...
            icon: U.isInstanceOf(p_model, SystemModel) ? `%ICON%/icon_lock.svg` : `%ICON%/icon_model.svg`,
