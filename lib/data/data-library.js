...
const { DATA_EVENT, DataFactory } = require(`@nkm/core-data`);
...
class DataLibrary extends DataFactory {
    ...
    _Init() {
        ...
        this._modelObserver.Hook(FIELD_EVENT.FIELD_ADDED, this, this._OnModelFieldAdded);
        this._modelObserver.Hook(FIELD_EVENT.FIELD_REMOVED, this, this._OnModelFieldRemoved);
        this._modelObserver.Hook(FIELD_EVENT.FIELD_UPDATED, this, this._OnModelFieldUpdated);
        this._modelObserver.Hook(FIELD_EVENT.FIELD_RENAMED, this, this._OnModelFieldRenamed);
