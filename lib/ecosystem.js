...
const { DATA_SIGNAL, DataBlock, Catalog } = require(`@nkm/data-core`);
...
class Ecosystem extends DataBlock {
    ...
    _OnEntityRegistered(p_entity) {
        ...
        p_entity.Watch(DATA_SIGNAL.CLEANED, this._OnEntityCleaned, this);
        if (p_entity.dirty) {
    ...
    _OnEntityUnregistered(p_entity) {
        ...
        p_entity.Unwatch(DATA_SIGNAL.CLEANED, this._OnEntityCleaned, this);
    }
